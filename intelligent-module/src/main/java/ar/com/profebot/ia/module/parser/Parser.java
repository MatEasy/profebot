package ar.com.profebot.ia.module.parser;
...
public class Parser
{
    LinkedList<sun.tools.jstat.Token> tokens;
    sun.tools.jstat.Token lookahead;
    ...
    public ExpressionNode parse(final String expression) throws ParserException, ParseException {
        ...
        final LinkedList<sun.tools.jstat.Token> tokens = tokenizer.getTokens();
    ...
    public ExpressionNode parse(final LinkedList<sun.tools.jstat.Token> tokens) throws ParseException, ParserException {
        this.tokens = (LinkedList<sun.tools.jstat.Token>)tokens.clone();
